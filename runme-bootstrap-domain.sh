...
# ---
builder api domain add-command-auth-rule    UserProfile   createUserProfile       userIdMustMatchToken
...
# ---
builder api domain add-aggregate-auth-rule   post    publishPost     mustBeOwnPost
